...
- [x] Добавлена единая настройка сортировки станций по имени, hostname, роли и
  статусу с переключением направления в реестре и publish wizard.
- [x] Preflight UI показывает конкретные совпавшие процессы: имя, PID и путь к
  executable для блокирующих и warning-правил.
